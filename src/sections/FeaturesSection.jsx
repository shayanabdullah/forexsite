  ...
  return (
    <section className="container mx-auto px-4 py-24">
      ...
      <div className=" max-w-2xl mb-20">
        <h2 className="text-5xl md:text-6xl  tracking-tight clash-display mb-6 text-left">
          Advanced Trading
          <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-7 min-h-[320px] centered-row">
           <AnimatePresence mode="wait">
             <motion.div className="glass rounded-xl overflow-hidden w-full relative" key={features[activeIndex].title} initial={{opacity:0, y:60}} animate={{opacity: 1, y:0}} exit={{opacity:0, x:-60}} transition={{duration: 0.5}} >
