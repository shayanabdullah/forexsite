  ...
  return (
    <section className="container mx-auto px-4 py-24">
      ...
      <div className="max-w-2xl mx-auto text-center mb-12">
        ...
        <p className="text-zinc-300/80 text-lg">
        ...
        {/* Pricing tier */}
          {
            pricingPlans.map((item) => (
              <PricingTier key={item.id} isPopular={item.popular} name={item.title} price={item.price} features={item.features} description={item.description}/>
            ))
          }
        </div>
    </section>
